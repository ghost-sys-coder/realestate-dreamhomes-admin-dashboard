...
export async function addDistrict(formData: FormData) {
    ...
    try {
        ...
        return {
            success: false,
            message: error instanceof Error ? error.message : "Failed to add district"
        }
    }
...
export async function addLocation(formData: FormData) {
    ...
    try {
        await db.insert(locationsTable).values({ name: location.trim(), districtId });
        revalidatePath("/dashboard/settings");
...
export async function deleteDistrict(id: string) {
    try {
        ...
        return {
            success: false,
            message: error instanceof Error ? error.message : "Failed to delete district"
        }
    }
}
