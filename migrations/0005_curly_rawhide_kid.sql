...
ALTER TABLE "properties" DROP COLUMN "region_name";--> statement-breakpoint
ALTER TABLE "properties" DROP COLUMN "district_name";--> statement-breakpoint
ALTER TABLE "properties" DROP COLUMN "city_name";